...
python -u train.py --batch_size 32 --epoch 50 --save_path ckpt_PASE_50h_libri_kaldimfcc_znrom_ctx3_tied \
       	--num_workers 25 --warmup 10000000 --net_cfg cfg/workers_kaldi_ctxt3.cfg \
