...
python -u -W ignore train.py --batch_size 32 --epoch 200 --save_path ckpt_PASE_50h_newMI_noW_QRNN_onlymfcc \
       	--num_workers 8 --warmup 10000000 --net_cfg cfg/onlymfcc.cfg \
	...
	--chunk_size 32000 --random_scale True --tensorboard True  --log_freq 20
