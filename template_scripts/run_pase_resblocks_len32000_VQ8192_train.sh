...
python -u train.py --batch_size 32 --epoch 50 --save_path ckpt_PASE_resnet_newMI_32000_overlapSPC30_VQ8192 \
       	--num_workers 4 --warmup 10000000 --net_cfg cfg/workers_resnet.cfg \
	--fe_cfg cfg/PASE_resnet_VQ8192.cfg --do_eval --data_cfg data/librispeech_data_50h.cfg \
