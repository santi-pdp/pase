...
python -u train.py --batch_size 20 --epoch 25 \
        --save_path ckpt_PASE_libri_swbd_newMI_noW_CATdenseskips_QRNN_addrev \
        ...
        --stats data/swbd1_30k_stats.pkl --lrdec_step 30 --lrdecay 0.5 \
        --chunk_size 32000 --random_scale --log_grad_keys rnn \
        --cchunk_prior \
        --data_root data/LibriSpeech_50h/wav_sel \
        --data_cfg data/librispeech_data_50h.cfg \
