...
SAVE_ROOT="US_interface_ckpts_ablation8/"
...
#SAVE_ROOT="US_vctk_ckpts_ablation8/"
...
#FE_CFG="../cfg/frontend_RF160ms_norm-emb50.cfg"
...
SE_BNAME="$SUP_MODEL$HIDDEN_SIZE"_"$UCKPT"_FE"$UEPOCH"_SEED$SEED
...
python -u nnet.py --spk2idx $SPK2IDX --data_root $DATA_ROOT --train_guia $TRAIN_GUIA \
	...
	--fe_cfg $FE_CFG --no-cuda \
	--fe_ckpt $FE_CKPT --seed $SEED $FT_FE
...
python -u nnet.py --spk2idx $SPK2IDX --data_root $DATA_ROOT --test_guia $TEST_GUIA \
	...
	--fe_cfg $FE_CFG --test_log_file $LOG_FILE --no-cuda
