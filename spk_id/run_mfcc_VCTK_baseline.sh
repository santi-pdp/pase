...
DATA_ROOT="../data/VCTK/spk_id/mfcc13_s160_d1d2"
...
SAVE_PATH="$SAVE_ROOT/MFCC_100epoch"
...
python -u mfcc_baseline.py --spk2idx $SPK2IDX --data_root $DATA_ROOT --train_guia $TRAIN_GUIA \
	...
	--seed $SEED $FT_FE --order 39 --stats stats/vctk_mfcc13s160d1d2.stats
...
python -u mfcc_baseline.py --spk2idx $SPK2IDX --data_root $DATA_ROOT --test_guia $TEST_GUIA \
	...
	--test_log_file $LOG_FILE --stats stats/vctk_mfcc13s160d1d2.stats
